    ...
    <body class="bg-slate-800 flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2  h-full animate-fade-right flex-col items-center justify-center">
            ...
            <div class="flex flex-wrap justify-center">
                <form @submit.prevent="guardarDatos" class=" bg-neutral-900 p-5 rounded-md animate-fade-down mb-10">
        ...
        <div class="w-full lg:w-1/2   bg-neutral-800  lg:border-l-8 border-t-8 lg:border-t-0  border-dotted border-neutral-900">
            <div class="flex justify-center pt-5">
                <img :src="perfil" alt="perfil" class="rounded-full w-32">
            </div>
            <div class="flex flex-col mb-10">
                <p class="text-white text-3xl text-center py-10">Hola! {{ usuario }}</p>
                <div class="bg-neutral-900 mx-10 rounded-md">
                    <p class="p-2">Usuario: {{ usuario }}</p>
                    <p class="p-2">Edad:{{ edad2 }}</p>
                    <p class="p-2">Correo:{{ correo2 }}</p>
                    <p class="p-2">Telefono:{{ telefono2 }}</p>
                </div>
            </div>
        </div>
    </body>
